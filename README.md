...
In total, you need to submit a folder containing **10 screenshots**. Each screenshot should be properly named so that it identifies the corresponding line coverage or branch coverage. 
